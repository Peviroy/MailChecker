// Acknowledge: https://codepen.io/davidkpiano/pen/wMqXea
<template>
  <div class="notfound">
    <div class="husky">
      <div class="mane">
...
.front-legs {
  ...
  &:before {
    ...
    bottom: 0;
    left: 47%;
    box-shadow: -1.3vmin 0 0 $color-light, -2.8vmin 0 0 $color-light, 1.3vmin 0 0 $color-bg, 2.8vmin 0 0 $color-bg;
    z-index: 2;
  }
